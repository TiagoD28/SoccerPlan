        ...
        <div class="my-card bgColor my-border-left-color shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold my-card-title-color text-uppercase mb-1">
                            Number Of Users</div>
    ...
    <!-- <div class="col-xl-3 col-md-6 mb-4">
        <div class="my-card bgColor my-border-left-color shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold my-card-title-color text-uppercase mb-1">Tasks
                        </div>
                        <div class="row no-gutters align-items-center">
                            <div class="col-auto">
