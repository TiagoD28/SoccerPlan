<?php
    ...
    $route = 'Coaches/index.php?route=getCoaches';

    $apiResponse = getDataFromApi($route);
    $data = $apiResponse['data'];

    $columnOrder = ['idClub', 'idUser', 'idCoach', 'username', 'firstName', 'lastName', 'age', 'nacionality', 'salary', 'img', 'idClothingSize', 'email', 'pass'];
