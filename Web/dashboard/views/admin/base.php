...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
            <a class="nav-link my <?php echo ($_SESSION['route'] == 'clubs') ? 'active' : ''; ?> collapsed" href="#" data-toggle="collapse" 
                data-target="#collapseClubs" aria-expanded="false" aria-controls="collapseClubs">
                <i class="fas fa-fw fa-table my <?php echo ($_SESSION['route'] == 'clubs') ? 'active' : ''; ?>"></i>
                <span>Clubs</span>
            </a>
                <div id="collapseClubs" class="collapse" aria-labelledby="headingClubs" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Clubs:</h6>
                        <a class="collapse-item" href="base.php?route=clubs">Clubs</a>
                        <a class="collapse-item" href="base.php?route=clubscodes">Clubs Codes</a>
                        <a class="collapse-item" href="base.php?route=clubsstadiums">Clubs Stadiums</a>
                        <a class="collapse-item" href="base.php?route=clubsevents">Clubs Events</a>
                        <a class="collapse-item" href="base.php?route=clubsmembers">Clubs Members</a>
                    </div>
                </div>
            </li>
            ...
            <a class="nav-link my <?php echo ($_SESSION['route'] == 'teams') ? 'active' : ''; ?> collapsed" href="#" data-toggle="collapse" 
                ...
                <div id="collapseTeams" class="collapse" aria-labelledby="headingTeams" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="base.php?route=teamscodes">Teams Codes</a>
                        <a class="collapse-item" href="base.php?route=teamsevents">Teams Events</a>
