...
const Chat = ({ userData }) => {
  ...
  useEffect(() => {
    ...
    // setMessageSended(false); // asdfasdfasf
  ...
  const onSend = useCallback((messages = []) => {
    ...
    // setMessageSended(true); // asdfasdfasdfasdf
  }, []);
  ...
  const getAvatarInitials = (name) => {
    ...
    const avatar = initials.substring(0, 2).toUpperCase();
       ...
       <HeaderBar
          ...
          {userLogged.idTeam ? (
              ...
              {isRefreshPressed ? (
                ...
                // {sortedMessages ? (
                  ...
                  user={{
                    ...
                    // avatar: dataUser.img ? {avatar: dataUser.img} : getAvatarInitials(dataUser.username),
                  }}
                />
                // ) : (
            ...
            <View style={styles.container}>
              <Text>You have to be on a Team!</Text>
            </View>
          )}
        </>
